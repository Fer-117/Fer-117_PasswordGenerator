...
do{
    LoCase = prompt("Include lowercase letters? Type \"yes\" or \"no\"");
    if(LoCase == "yes"){
        lowerCase = true;
        optionsCounter++;
        break;
        ...
        alert("Please write \"yes\" or \"no\" in lowercase.");
    }
...
function generatePassword(){
    ...
    document.querySelector("textarea").innerHTML = `Your password is:\n ${shuffledPassword}\nThe length of the password is ${shuffledPassword.length} characters.`;
